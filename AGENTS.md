...
- Hermes adapter mapping belongs as a **compiler profile**, not as a second Kanban. o8's profile is `profiles/o8.md`; the compiler still lives in the harness repo.
