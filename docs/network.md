...
Human contract: [`working-note.md`](working-note.md). Intent/participation profile: [`profiles/intent-contract.md`](../profiles/intent-contract.md). AODL owns the formal contract. Hermes owns contextual runtime. Dash/OMP/o8 decode it. Ripple is the Dash-consumed ephemeral intent surface; AODL does not own it. Do not grow a second catalog or scheduler here.
